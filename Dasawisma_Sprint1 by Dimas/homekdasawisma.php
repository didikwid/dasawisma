...
<body id="body-pd">
    ...
    <?php
    $query = mysqli_query($koneksi, "SELECT *FROM kdasawisma");
    while ($data = mysqli_fetch_assoc($query)) {
    ?>

        <!-- Jumbotron -->
        <div class="jumbotron text-center">
            <img src="personal.jpg" alt="Ketua Dasawisma" width="100" class="rounded-circle img-thumbnail" />
            <h4>Ketua Dasawisma</h4>
            <p class="lead">
            <p><? echo $data['NIK'] ?></p>
            <p><? echo $data['Nama'] ?></p>
        <?php } ?>
