...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Data Keluarga Dasawisma</title>
			...
			<div class="sidebar">
				<div class="sidebar-menu">
					...
					<li class="item" id="settings">
						...
						<div class="sub-menu">
							<a href="Datakeluargaanggota.php" class="active">
								<i class="fas fa-file"></i><span>Data Keluarga</span>
							</a>
							<a href="Dataperkarangananggota.php">
								<i class="fas fa-file"></i><span>Pemanfaatan Perkarangan</span>
							</a>
                            <a href="Pengumumananggota.html">
                ...
                <div class="card mt-3" style="background-color: rgba(231, 116, 185, 0.6);">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php
                            $no = 1;
                            $tampil = mysqli_query($koneksi, "SELECT * from keluarga order by idkeluarga asc");
