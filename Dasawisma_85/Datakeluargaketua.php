			...
			<div class="sidebar">
				<div class="sidebar-menu">
					...
					<li class="item" id="settings">
						...
						<div class="sub-menu">
							<a href="Datakeluargaketua.php" class="active">
								<i class="fas fa-file"></i><span>Data Keluarga</span>
							</a>
							<a href="Dataperkaranganketua.php">
			...
			<div class="main-container">
                ...
                <div class="card mt-3" style="background-color: rgba(231, 116, 185, 0.6);">
                    ...
                    <div class="card-body">
                        ...
                        <a href="TambahKeluarga.php" class="btn btn-info fw-bold text-white mt-2" style="width: 140px; margin:5px;">Tambah Data</a>
                    </div>
                </div>
                <!-- Akhir Card Tabel -->
			</div>
