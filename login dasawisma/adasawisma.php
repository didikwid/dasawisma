...
if (isset($_POST['ilogin'])) {
    ...
    $login = mysqli_query($koneksi, "select * from adasawisma where NIK='$NIK'");
...
<body>
    ...
    <div class="data-form">
        <form method="post" action="#">
            ...
            <h6 style="text-align:center"><b>Login sebagai Anggota Dasawisma :</b></h6>
